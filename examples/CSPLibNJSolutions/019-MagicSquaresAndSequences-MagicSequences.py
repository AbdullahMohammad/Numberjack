...
def get_model(N):
    ...
    # A boolean matrix to represent which positions each number appears
    # at in the sequence. Rows represent the numbers in sequence, and
    # columns represent the  positions in sequence.
    ...
    model = Model(
        ...
        # Each number i must appear as many times in the sequence as the
