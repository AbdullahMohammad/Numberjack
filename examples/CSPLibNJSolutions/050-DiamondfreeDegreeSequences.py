...
# - For every grouping of four rows, the sum of their non-symmetrical values is less than or equal to 4,
...
# Note on first constaint:
# A group of four nodes can have at most four edges between them.
# Since the matrix for this model will represent the adjacency matrix of the graph,
# we need to take into consideration the fact that the matrix will be symmetrical
