...
# An order n hetero square is a n by n matrix containing the numbers 1 to n^2, with each row, column and main diagonal summing to a different value.
...
if __name__ == '__main__':
    default = {'N': 3, 'data': 'data/019-MagicSquaresAndSequences-HeteroSquares.txt', 'solver': 'Mistral', 'verbose': 1}
    param = input(default)
    solve(param)
