...
#
# An order n magic square is a n by n matrix containing the
...
def get_model(N, data):
    ...
    # The minimum sum of a row is the sum of the first N smallest
    # numbers in the domain of 1 to N^2. That is equivalent to the
    # sum of numbers 1 to N.
    minimum = N * (N+1) / 2

    # The maximum sum of a row is the sum of the last N biggest
    # numbers in the domain of 1 to N^2. That is equivalent to
    # the difference between the sum of the numbers 1 to N^2 and
    # the sum of the numbers 1 to (N^2 - N)
...
if __name__ == '__main__':
    default = {'N': 3, 'solver': 'Mistral', 'verbose': 1,
               'data': 'data/019-MagicSquaresAndSequences-MagicSquares.txt'}
    param = input(default)
    solve(param)
